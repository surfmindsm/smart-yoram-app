...
고린도 (이하 "앱")는 서프마인드(주)에서 운영하는 교회 관리 애플리케이션으로, 사용자의 개인정보를 중요하게 생각하며 「개인정보보호법」을 준수하고 있습니다. 본 개인정보처리방침은 앱에서 수집하는 개인정보의 항목, 수집 및 이용목적, 보유 및 이용기간, 파기절차 등에 관한 사항을 안내드립니다.
