...
class TermsOfServiceScreen extends StatelessWidget {
            ...
            AppCard(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '서프마인드(주)\n'
                    '주소: 서울특별시 강남구 테헤란로 146, 8층\n'
                    '전화: 02-6956-8903\n'
                    '이메일: info@surfmind.co.kr',
                    style: TextStyle(
                      fontSize: 14.sp,
                      height: 1.5,
  ...
  String _getTermsOfServiceText() {
    return '''제1조 (목적)
본 약관은 서프마인드(주)(이하 "회사")가 개발하고 운영하는 고린도 모바일 애플리케이션(이하 "서비스") 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

제2조 (정의)
본 약관에서 사용하는 용어의 정의는 다음과 같습니다.
1. "서비스"란 회사가 제공하는 고린도 모바일 애플리케이션을 통해 제공되는 모든 서비스를 의미합니다.
2. "이용자"란 본 약관에 따라 서비스를 이용하는 교인 및 방문자를 의미합니다.
3. "교인"이란 교회에 등록된 모든 교인을 의미합니다.
