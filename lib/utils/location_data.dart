...
class LocationData {
  static const Map<String, List<String>> locations = {
    ...
    '경기도': [
      '수원시', '성남시', '용인시', '고양시', '안양시', '안산시', '부천시', '광명시',
      '평택시', '과천시', '오산시', '시흥시', '군포시', '의왕시', '하남시', '남양주시',
      '구리시', '의정부시', '양주시', '동두천시', '파주시', '포천시', '연천군', '김포시',
      '화성시', '광주시', '이천시', '여주시', '양평군', '가평군', '안성시'
    ],
    '강원도': [
  ...
  static List<String> getDistricts(String? city) {
    if (city == null || !locations.containsKey(city)) {
      return [];
    }
  ...
  /// 위치 문자열 생성
  static String createLocationString(String city, String district) {
    return '$city $district';
  }

  /// 위치 문자열 파싱
  static Map<String, String?> parseLocationString(String? location) {
